...
people = {
    "david_costa": {"name":  "David Costa",
                  ...
                  "short_info":"David Costa has been in the boating industry for nearly 20 years",
                  "info":"David Costa has been in the boating industry for nearly 20 years. David began selling marine fuel in 2005 with Costa Oil Marine Division and in 2019 started DC Fuel Service. David brings accounting and logistical expertise to help Miami Marine Management run its day to day operations.",
                  "instagram": "https://www.instagram.com/dcost22/"},
    "mark_lopez": {"name":  "Mark Lopez",
                  "photo": "https://writingcenter.fas.harvard.edu/sites/hwpi.harvard.edu/files/styles/os_files_xxlarge/public/writingcenter/files/person-icon.png?m=1614398157&itok=Bvj8bd7F",
                  "short_info":"Born and raised in Miami, Florida, Mark Lopez has over a decade",
                  "info": "Born and raised in Miami, Florida, Mark Lopez has over a decade of experience in the marine industry, is a licensed captain, and a fellow boater. Mark has successfully participated in numerous fishing tournaments, showcasing his exceptional skills and unwavering commitment. As a fellow boater, Mark understands the unique needs and desires of clients who share a love for the open sea.",
